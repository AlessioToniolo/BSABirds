	...
	<div class="flex flex-wrap justify-center">
		<div class="text-center">
			<div class="sm:basis-1/2 text-center mb-5 pt-10 ">
				<a href="/auto"
					><p class="text-primary font-extrabold text-3xl">Track Brookhaven Birds</p></a
				>
			</div>
		...
		<div class="container min-width-max flex justify-center py-10">
			<div class="card w-80 bg-base-100 shadow-xl image-full">
				<figure><img src="murphey.jpeg" alt="Shoes" /></figure>
				<div class="card-body">
		...
		<div class="container min-width-max flex justify-center py-10">
			<div class="card w-80 bg-base-100 shadow-xl">
				<figure><img src="motmot.jpeg" alt="Motmot" /></figure>
				<div class="card-body">
